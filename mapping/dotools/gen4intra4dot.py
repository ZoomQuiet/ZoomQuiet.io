...
'''Changelog:
    ...
    - 150316 fixed for Intra. mapping
...
%(jsActions)s
    ...
    <script type="text/javascript">
        ...
        var disqus_shortname = 'bmc4gzcmcm'; // required: replace example with your forum shortname
